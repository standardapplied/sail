 ...
 * request so {@code SailOperations} can skip the read freshen and the write-triggered propagation
 * for exactly that request and act on the local replica as-is. Unbound (the Unix-socket lane,
 * direct calls in tests) means sync as usual.
 */
